...
!function() {
    ...
    function S(e, t, r, n, o, i, a, s, c, f, _) {
        var p, v, g, b, w, S = n && n.__k || l, x = t.length;
        for (r.__d = c,
        function(e, t, r) {
            var n, o, i, a, s, u = t.length, l = r.length, c = l, f = 0;
            for (e.__k = [],
            n = 0; n < u; n++)
    ...
    function F(r, n, o, i, a, s, l, c, p, m) {
        ...
        e: if ("function" == typeof L)
            ...
            n.__e = o.__e) : n.__e = function(t, r, n, o, i, a, s, l, c) {
                var f, p, m, h, v, g, b, w = n.props, N = r.props, x = r.type;
                if ("svg" === x && (i = !0),
                null != a)
    ...
    w.__r = 0,
    s = 0;
    var R, j, U, B, H = 0, q = [], W = [], G = t.__b, X = t.__r, Y = t.diffed, z = t.__c, Z = t.unmount;
    function J(e, r) {
        t.__h && t.__h(j, e, H || r),
        H = 0;
        var n = j.__H || (j.__H = {
    ...
    const st = ({island: e, widget: t, rootFragment: r, props: n})=>{
        e.props = n,
        V(p(t, n), r)
    }
    ;
    ...
    var _r = e=>wt(e) && !ar(e) ? e : {
      ...
      , pr = async(e,t,r,n,o)=>{
        const {ref: i, refs: a, required: s, maxLength: u, minLength: l, min: c, max: d, pattern: f, validate: _, name: p, valueAsNumber: m, mount: h, disabled: v} = e._f
          , y = At(t, p);
        if (!h || v)
            return {};
        const g = a ? a[0] : i
    ...
    var kr = (e,t)=>xr(e, t, Nr(t))
      , Er = (e,{valueAsNumber: t, valueAsDate: r, setValueAs: n})=>Ot(e) ? e : t ? "" === e ? NaN : e ? +e : e : r && qt(e) ? new Date(e) : n ? n(e) : e;
    function Cr(e) {
        const t = e.ref;
        if (!(e.refs ? e.refs.every((e=>e.disabled)) : t.disabled))
            return tr(t) ? t.files : ir(t) ? dr(e.refs).value : gr(t) ? [...t.selectedOptions].map((({value: e})=>e)) : vt(t) ? lr(e.refs).value : Er(Ot(t.value) ? e.ref.value : t.value, e)
    }
    var Or = (e,t,r,n)=>{
        const o = {};
        for (const i of e) {
    ...
    function Vr(e={}, t) {
        let r, n = {
            ...
            dirtyFields: {},
            errors: {}
        }, i = {}, a = (wt(n.defaultValues) || wt(n.values)) && Et(n.defaultValues || n.values) || {}, s = n.shouldUnregister ? {} : Et(a), u = {
            action: !1,
            mount: !1,
            watch: !1
        }, l = {
        ...
        const d = {
          ...
          , S = async e=>n.resolver(s, n.context, Or(e || l.mount, i, n.criteriaMode, n.shouldUseNativeValidation))
          , N = async(e,t,r={
            valid: !0
        })=>{
            for (const i in e) {
        ...
        !yr(T(), a))
          ...
          , I = ()=>n.shouldFocusError && Zt(i, (e=>e && At(o.errors, e)), l.mount)
          , L = (e,t)=>async r=>{
    ...
    const Lr = "cgf"
      ...
      , jr = e=>{
        const {title: t, options: r={}, onBack: n=(()=>{}
        )} = e
          , o = r.title || t
          , i = r.description || "Your response has been recoreded."
          , a = Boolean(r.isSubmitAnother)
          , s = r.submitAnotherTitle || "Submit another response";
        return lt("div", {
    ...
    const Hr = /^[^\s@]+@[^\s@]+\.[^\s@]+$/
      ...
      , Wr = {
        [1]: {
            ...
            ,
            [7]: (e,t={})=>{
                const {firstValue: r, secondValue: n, error: o} = t
                  , i = parseFloat(e);
      ...
      , Zr = ye(((e,t)=>{
        const {name: r, label: n, type: o, description: i, className: a, rootClass: s, error: u="", field: l={}, ...c} = e
          , {register: d} = jt()
          , {withTime: f=!1, rules: _=[], required: p} = l
          , m = Gr(_, p)
          , h = m ? d(r, m) : {};
        return lt("label", {
            className: Mr.group,
    ...
    const Jr = e=>{
        const {label: t, description: r, className: n, name: o, error: i=null, field: a={}, ...s} = e
          , {withTime: u=!1, rules: l=[], required: c} = a
          , d = !!i
          , {register: f} = jt()
          , _ = Gr(l, c)
          , p = _ ? f(o, _) : {};
      ...
      , Kr = e=>{
        const {label: t, radioCustom: r, description: n="", className: o="", error: i="", options: a=[], name: s, required: u, ...l} = e
          , c = !!i
          , {register: d} = jt();
        return lt("div", {
            className: Mr.group,
            children: [lt(Xr, {
                ...
                children: a.map((({label: e, custom: t})=>lt("label", {
      ...
      , en = e=>{
        const {label: t, legend: r={}, description: n="", className: o="", error: i="", name: a, required: s, options: u=[], ...l} = e
          , {labelFirst: c, labelLast: d} = r
          , f = !!i
          , {register: _} = jt();
        return lt("div", {
            className: Mr.group,
      ...
      , tn = e=>{
        const {label: t, description: r="", className: n="", error: o="", options: i=[], name: a, required: s, ...u} = e
          , l = !!o
          , {register: c} = jt();
        return lt("label", {
            className: Mr.group,
      ...
      , on = e=>{
        const {children: t, disabled: r=!1, type: n="button", variant: o="primary", ...i} = e;
        return lt("button", {
            disabled: r,
            type: n,
      ...
      , sn = ({fields: e=[], step: t=0})=>{
        const {setValue: r, formState: {errors: n}} = jt();
        return e.length > 0 && e.map(((e,o)=>{
            var i;
            const {id: a, type: s="TEXT", label: u, required: l, description: c, options: d=[], items: f=[], legend: _={}} = e
              , p = an(s)
              , m = `${a}${p}`
              , h = (null == (i = n[m]) ? void 0 : i.message) || null;
      ...
      , un = e=>{
        const {formData: t, onSubmit: r, isLoading: n=!1} = e
          , {id: o, title: i=null, description: a=null} = t
          , {trigger: s} = jt()
          , u = (null == t ? void 0 : t.fields) || []
          , l = (null == t ? void 0 : t.settings) || {}
          , c = (null == l ? void 0 : l.form) || {}
          , d = (null == c ? void 0 : c.submit) || "Submit"
          , {fields: f=[], stepsCount: _, isWizzard: p} = ((e=[])=>{
            const t = e.some((({type: e})=>"SECTION" === e))
              , r = [];
            let n;
      ...
      , pn = e=>{
        ...
        null == r || r.mode;
        const {id: n, userId: o="", preview: i="form", googleFormId: a="", title: s="", theme: u="minimal", customTheme: l={}, settings: c={}} = t
          , {type: d=Rr.page, redirectUrl: f} = (null == c ? void 0 : c.success) || {}
          , {showBrandedLogo: _=!0} = (null == c ? void 0 : c.form) || {}
          , [p,m] = K(!1)
          , [h,v] = K(!1)
          , y = Ir({
            mode: "all",
    ...
    function yn() {}
    var gn = mn() ? te : ee
      , bn = ({children: e, type: t="reach-portal", containerRef: r})=>{
        let n = re(null)
          , o = re(null)
          , i = function() {
      ...
      , wn = ({unstable_skipInitialRender: e, ...t})=>{
        let[r,n] = K(!1);
        return ee((()=>{
            e && n(!0)
        }
    ...
    var Vn = Dn({}, (function(e) {
      ...
      , Rn = []
      , jn = ye((function(e, t) {
        var r, n = K(), o = n[0], i = n[1], a = re(), s = re(!1), u = re(null), l = e.children, c = e.disabled, d = e.noFocusGuards, f = e.persistentFocus, _ = e.crossFrame, m = e.autoFocus;
    ...
    var Wn = function(e) {
      ...
      , bo = function(e, t, r, n) {
        var o = e.length
          ...
          , s = Jn(r);
        if (!(e.indexOf(r) >= 0)) {
            var u, l, c = t.indexOf(r), d = n ? t.indexOf(n) : c, f = n ? e.indexOf(n) : -1, _ = c - d, p = t.indexOf(i), m = t.indexOf(a), h = (u = t,
            l = new Set,
            ...
            ))), v = h.indexOf(r) - (n ? h.indexOf(n) : c), y = yo(e, 0), g = yo(e, o - 1);
    ...
    const vi = (yi = function(e) {
        ...
        var s = oe((function(e, t) {
            ...
            var o, i = di(e), s = r.current, u = "deltaX"in e ? e.deltaX : s[0] - i[0], l = "deltaY"in e ? e.deltaY : s[1] - i[1], c = e.target, d = Math.abs(u) > Math.abs(l) ? "h" : "v", f = ii(d, c);
            if (!f)
                return !0;
            if (f ? o = d : (o = "v" === d ? "h" : "v",
            f = ii(d, c)),
    ...
    function Ni({isOpen: e=!0, children: t, ...r}) {
        return ee((()=>{
    ...
    var xi = ye((function({allowPinchZoom: e, as: t="div", dangerouslyBypassFocusLock: r, dangerouslyBypassScrollLock: n, initialFocusRef: o, onClick: i, onDismiss: a=yn, onKeyDown: s, onMouseDown: u, unstable_lockFocusAcrossFrames: l, ...c}, d) {
        let {isOpen: f} = Si("DialogInner")
          , _ = void 0 !== l;
        ee((()=>{
    ...
    var ki = ye((function({as: e="div", isOpen: t=!0, ...r}, n) {
        return t ? p(Ni, {
            isOpen: t
        }, p(xi, {
    ...
    var Ei = ye((function({as: e="div", onClick: t, onKeyDown: r, ...n}, o) {
        let {isOpen: i} = Si("DialogContent");
        return p(e, {
            "aria-modal": "true",
            role: "dialog",
            tabIndex: -1,
    ...
    ye((function({allowPinchZoom: e=!1, initialFocusRef: t, isOpen: r, onDismiss: n=yn, ...o}, i) {
        return p(ki, {
            allowPinchZoom: e,
            initialFocusRef: t,
            isOpen: r,
    ...
    const Ci = e=>{
        const {formData: t, dataProps: r} = e
          , {label: n="Show form", style: o} = r
          , {id: i, userId: a="", preview: s="form", googleFormId: u="", title: l="", theme: c="minimal", customTheme: d={}, settings: f={}} = t
          , [_,p] = K(!1)
          , m = ()=>{
            dn({
    ...
    const Ti = e=>{
      ...
      , $i = e=>{
        const {formId: t, dataProps: r} = e
          , n = `${dt}/config/${t}.json`
          , {data: o, error: i} = function(e, t) {
            console.log(n);
            const r = re({})
              , n = re(!1)
              , o = {
      ...
      , Pi = ({formData: e, dataProps: t})=>lt(Di, {
        formData: e,
        dataProps: t
    })
      , Vi = e=>{
    ...
    (()=>{
        ...
        const e = (e=>{
            const t = {
                ...
                props: {},
                render: ({selector: r, clean: n=!1, replace: o=!1, inline: i=!1, initialProps: a={}, propsSelector: s, elementName: u})=>{
                    let l = !1;
                    const c = ()=>{
                        if (!0 === l)
                            return;
                        const c = (({selector: e, inline: t, elementName: r})=>{
                        ...
                        if (0 === c.length)
                            return;
                        const {rootFragments: d} = (({island: e, widget: t, hostElements: r, clean: n, replace: o, initialProps: i, propsSelector: a})=>{
                            const s = [];
                            return r.forEach((r=>{
                                const u = it(e, r, i, a);
                                let l;
                                ...
                                const c = (({island: e, hostElement: t, initialProps: r, onNewProps: n, propsSelector: o})=>{
